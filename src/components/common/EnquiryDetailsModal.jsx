...
const EnquiryDetailsModal = ({ selection, enquiries, onClose, onEdit }) => {
  ...
  useEffect(() => { setSearchText(''); setPage(1) }, [selection])
  ...
  return <DetailsModal isOpen={Boolean(selection)} title={`${selection?.status || ''} / ${selection?.source || ''} Enquiries`} onClose={onClose} size="large">
