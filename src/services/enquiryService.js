...
const validate = (data) => {
  ...
  if (data.productAmount !== '' && data.productAmount !== undefined && (Number.isNaN(Number(data.productAmount)) || Number(data.productAmount) < 0)) throw new Error('Enter a valid Product Amount.')
