...
const SalesVoucher = () => {
  ...
  return <div className="page-stack">
    ...
    <section className="panel-card" style={{ marginTop: 18 }}>
      ...
      {isMobile ? <div className="customer-mobile-list">{pagedVouchers.map((voucher) => <div className="customer-mobile-card" key={voucher.id}>
        ...
        {loading && !vouchers.length && <tr><td colSpan="10" className="text-center">Loading vouchers...</td></tr>}{!loading && !filteredVouchers.length && <tr><td colSpan="10" className="text-center">{searchText ? 'No matching vouchers found.' : 'No vouchers found.'}</td></tr>}
