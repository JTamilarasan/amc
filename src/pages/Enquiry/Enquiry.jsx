...
const Enquiry = () => {
  ...
  const selectCustomer = (customer) => {
    setForm((current) => ({ ...current, customerId: customer?.id || '', customerName: customer?.customerName || '', contactNumber: customer?.mobileNo || '', areaId: customer?.areaId || '', areaName: customer?.areaName || '' }))
