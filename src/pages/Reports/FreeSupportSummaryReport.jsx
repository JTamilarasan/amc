...
const definitions = { active: 'Active Free Support Customers', expired: 'Expired Free Support Customers', new: 'New Free Support', 'going-to-expire': 'Free Support Going to Expire', dropped: 'Dropped Free Support Customers', converted: 'Converted to AMC' }
const FreeSupportSummaryReport = () => {
  ...
  const convert = async (record) => { await freeSupportVoucherService.markFreeSupportConverted(record.id); setMessage(`${record.customerName} converted to AMC.`); await load() }
